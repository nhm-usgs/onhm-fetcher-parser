...
with open(r'../SierraData/test3.nc', 'wb') as fh:
    fh.write(myfile.content)
    fh.close()

uofi_file = r'../SierraData/test3.nc'
ds = xr.open_dataset(uofi_file)
print(ds)
#Read NHM hru shapefiles into geopandas dataframe
print(os.getcwd())
from pathlib import Path
folder = Path(r'../SierraData') # assumes working directory is onhm-fetcher-parser
print(folder)
...
tcount = 0
with open('../SierraData/Sierra_weights_hru_v3.csv', 'w', newline='') as f:
